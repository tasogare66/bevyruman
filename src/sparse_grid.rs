/*! bevy_sparse_grid_2d | MIT License | github.com/johanhelsing/bevy_sparse_grid_2d/blob/main/LICENSE-MIT */
...
impl Aabb {
    #[inline]
    pub fn from_circle(v: Vec2, r: f32) -> Self {
        let splatr = Vec2::splat(r);
        Self {
            min: v - splatr,
            max: v + splatr,
        }
